...
🚀 Try it now: [Defi Builder AI](https://oraichain-builder.app.genez.io/)
...
1. Clone the repository:
   ...
   ```sh
   git clone https://github.com/thedefibuilder/hackathon-oraichain.git
   ```

2. Navigate to the project directory and install dependencies:

   ```sh
   cd hackathon-oraichain/back-end
   npm install
   cd ../front-end
   npm install
   ```
